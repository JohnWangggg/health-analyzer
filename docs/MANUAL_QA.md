...
- [ ] 「保留月数」可选 **3 / 6 / 12 / 24**，点「仅保留近 N 个月」只保留最新 N 个月、更早月份删除
...
- [ ] 可多选年份 →「删除所选年」
- [ ] 「保留年数」可选 **1 / 2 / 3 / 5**，点「仅保留近 N 年」只保留最新 N 个有数据年份

**体重年分片（体脂随体重年）**

- [ ] 有体重时展示年列表（`weight|YYYY`）；**体脂与体重同年片**，删体重年则该年体脂一并去掉
- [ ] 可多选删除；「仅保留近 N 年」与血压类似（1/2/3/5）
- [ ] 「双域仅保留近 N 年」一键同时裁血压与体重（两域共用同一 N）
- [ ] （可选）勾选「保存后自动按保留窗口裁剪」：再保存 / 刷新自动恢复后，CGM 与年分片落在 keep-N 内；**默认关闭**
...
| 数据仓 / 年分片 / 加密备份 | `e2e/warehouse.spec.js` |
